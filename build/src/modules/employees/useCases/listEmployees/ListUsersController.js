...
class ListEmployeesController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const listEmployeesUseCase = new ListUsersUseCase_1.ListEmployeesUseCase(new EmployeeRepository_1.EmployeeRepository);
            const all = yield listEmployeesUseCase.execute();
